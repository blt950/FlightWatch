...
namespace FlightWatch
{
    ...
    {
        // Source: https://github.com/CrisBR/cdu777/blob/master/CDU777/PmdgSDK.cs
        ...
        public struct PMDG_777X_Data
        {
            ...
            // Wiper Selectors
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] WIPERS_Selector;		// left/right   0: OFF  1: INT  2: LOW  3:HIGH
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] AIR_ShoulderHeaterKnob;	// Left / Right  Position 0...150
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] COMM_ReceiverSwitches;	// array: 0=capt, 1=F/O, 2=observer  values: Bit flags for selector receivers 0...12 (VHFL..APP) as listed above
        ...
        public const UInt16 ACP_SEL_RECV_VHFL = 0x0001;
        public const UInt16 ACP_SEL_RECV_VHFC = 0x0002;
        public const UInt16 ACP_SEL_RECV_VHFR = 0x0004;
        public const UInt16 ACP_SEL_RECV_FLT = 0x0008;
        public const UInt16 ACP_SEL_RECV_CAB = 0x0010;
        public const UInt16 ACP_SEL_RECV_PA = 0x0020;
        public const UInt16 ACP_SEL_RECV_HFL = 0x0040;
        public const UInt16 ACP_SEL_RECV_HFR = 0x0080;
        public const UInt16 ACP_SEL_RECV_SAT1 = 0x0100;
        public const UInt16 ACP_SEL_RECV_SAT2 = 0x0200;
        public const UInt16 ACP_SEL_RECV_SPKR = 0x0400;
        public const UInt16 ACP_SEL_RECV_VOR_ADF = 0x0800;
        public const UInt16 ACP_SEL_RECV_APP = 0x1000;
        ...
        public enum PMDGEvents : uint
        {
            ...
            EVT_DOOR_OVERWING_EXIT_L = (THIRD_PARTY_EVENT_ID_MIN + 14019),
            EVT_DOOR_OVERWING_EXIT_R = (THIRD_PARTY_EVENT_ID_MIN + 14020),
