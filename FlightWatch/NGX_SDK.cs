...
namespace FlightWatch
{
    public class NGX_SDK
    {
        ...
        public struct PMDG_NGX_Data
        {
            ...
            public uint ReceiverSwitches_0; // Bit flags for selector receivers (see ACP_SEL_RECV_VHF1 etc): [0]=Capt, [1]=FO, [2]=Overhead
            public uint ReceiverSwitches_1;
            public uint ReceiverSwitches_2;
            public byte MAIN_annunAP_Amber; // bool MAIN_annunAP_Amber[2];             // Amber color            
            public byte MAIN_annunAP_Amber1; // bool MAIN_annunAP_Amber[2];             // Amber color            
            public byte MAIN_annunAT_Amber; // bool MAIN_annunAT_Amber[2];             // Amber color
            public byte MAIN_annunAT_Amber1; // bool MAIN_annunAT_Amber[2];             // Amber color
            public int ICE_WindowHeatTestSw;               // 0: OVHT  1: Neutral  2: PWR TEST "0: OVHT 1: Neutral 2: PWR TEST", "U32"
            ...
            public float AIR_DuctPressNeedle;           // Value - degrees C
            public float AIR_DuctPressNeedle1;           // Value - degrees C
